            ...
            <div class="navbar-wrapper content-main  container">
                <div class="navbar-content scroll-div ps ps--active-y">
                    <ul class="nav pcoded-inner-navbar ">
                        ...
                        <li class="nav-item"><a href="/user/scan" class="nav-link "><span class="pcoded-micon"><i class="feather icon-activity"></i></span><span class="pcoded-mtext">Scan Image</span></a></li>
                        <li class="nav-item"><a href="/user/home" class="nav-link "><span class="pcoded-micon"><i class="feather icon-bar-chart-2"></i></span><span class="pcoded-mtext">Scan History</span></a></li>
                        <li class="nav-item"><a href="/user/changepassword" class="nav-link "><span class="pcoded-micon"><i class="feather icon-rotate-cw"></i></span><span class="pcoded-mtext">Change Password</span></a></li>
                        <li class="nav-item"><a href="/user/logout" class="nav-link "><span class="pcoded-micon"><i class="feather icon-log-out"></i></span><span class="pcoded-mtext">Log Out</span></a></li>
                    </ul>
